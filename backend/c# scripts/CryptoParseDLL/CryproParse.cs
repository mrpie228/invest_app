...
{
    public class CryproParse
    {
        public static async Task EnterParse()
        {
            CheckLogs();
            await Task.Run(()=> SerializableAsync());
        }
        ...
        private static void CheckLogs()
        {
            ...
            string Cryptopath = @$"Crypto";
            DirectoryInfo CryptodirInfo = new DirectoryInfo(path);

            if (!CryptodirInfo.Exists)
            {
                CryptodirInfo.Create();
            }
        }
        ...
        private static async Task SerializableAsync()
        {
            try
            {
                var url = GetUrl();
